...
def run_validation(
    ...
    file_names = ["Port_Hedland_WA_2020_CY_ARDC_polygons.gpkg",
    ...
    East_VIC_grid_codes =  ['x41y13', 'x41y14', 'x42y13', 'x42y14', 'x43y13', 'x43y14', 'x44y13', 'x44y14']
    FNQ_grid_codes =  ['x40y39', 'x41y39', 'x42y39']
    Port_Hedland_grid_codes =  ['x14y32', 'x14y33', 'x15y32', 'x15y33']
    Esperance_codes= ['x15y18', 'x15y19', 'x15y20', 'x16y18', 'x16y19', 'x16y20', 'x17y18', 'x17y19', 'x17y20', 'x18y18', 'x18y19', 'x18y20', 'x19y18', 'x19y19', 'x19y20', 'x20y18', 'x20y19', 'x20y20']
    ...
    all_study_sites_codes = {"kangaroo_Island_SA": Kangaroo_Island_grid_codes, 
    ...
    overall_climate_df.to_csv(f"performance-report/{algo_name}-climate-class-overall.csv", index=False)
